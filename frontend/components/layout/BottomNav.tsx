...
export function BottomNav() {
  ...
  // Calculate total unread count from active chats only
  const totalUnreadCount = chatsData?.chats?.reduce((sum: number, chat: any) => {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 z-40 shadow-sm" style={{ position: 'fixed', bottom: 0, transform: 'translateZ(0)', willChange: 'transform' }}>
