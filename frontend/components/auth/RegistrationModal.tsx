...
export function RegistrationModal({ isOpen, onClose, onSuccess }: RegistrationModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black bg-opacity-50 p-4 overflow-hidden" style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0 }}>
